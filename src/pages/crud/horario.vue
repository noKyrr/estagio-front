...
export default {
  ...
  methods: {
    ...
    submit () {
      ...
      axios({
        baseURL: this.modelo.id ? 'https://estagio-back.herokuapp.com//horario/' + this.modelo.id : `https://estagio-back.herokuapp.com//horario`,
        timeout: 10000,
    ...
    request () {
      ...
      axios
        .get(`https://estagio-back.herokuapp.com//horario`)
        .then(response => {
    ...
    excluiModel (id) {
      this.$q.dialog({
        ...
        axios({
          method: 'delete',
          url: 'https://estagio-back.herokuapp.com//horario/' + id,
          headers: {'content-Type': 'application/json', 'Accept': 'application/json'}
        }).then(response => {
          this.$q.notify({
            color: 'positive',
