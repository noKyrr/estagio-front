  ...
  methods: {
    ...
    submit () {
      if (this.errocpf || this.erropis) {
        ...
        axios({
          baseURL: this.modelo.id ? 'https://estagio-back.herokuapp.com//funcionario/' + this.modelo.id : `https://estagio-back.herokuapp.com//funcionario`,
          timeout: 10000,
    ...
    departCombobox () {
      let temp = []
      axios
        .get(`https://estagio-back.herokuapp.com//departamento`)
        .then(response => {
    ...
    excluiModel (id) {
      this.$q.dialog({
        ...
        axios({
          method: 'delete',
          url: 'https://estagio-back.herokuapp.com//funcionario/' + id,
