    ...
    <q-card-separator />
      <div class="row q-pa-lg gutter-sm justify-center">
        <div class="col-12">
          <q-field
            :count="75"
            helper="Razão social da empresa"
            error-label="Some error"
          >
            <q-input
              v-model="modelo.razao"
        ...
        <div class="col-12">
          <q-field
            :count="75"
            helper="Nome Fantasia da empresa"
            error-label="Some error"
          >
            <q-input
              v-model="modelo.fantasia"
        ...
        <div class="col-xs-12 col-sm-6">
          <q-field
            helper="Selecione o responsável"
            error-label="Some error"
          >
            <q-select
              v-model="modelo.responsavel"
              :options="responsaveis"
              :disable="responsaveis.length === 0"
              filter
              autofocus-filter
