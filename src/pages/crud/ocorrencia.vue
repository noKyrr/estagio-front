    ...
    <q-card-separator />
      <div class="row q-pa-lg gutter-sm justify-center">
        ...
        <div class="col-12">
          <q-field
            :count="75"
            helper="Descrição da Ocorrência"
            error-label="Some error"
          >
            <q-input
        ...
        <div class="col-12">
          <q-field
            :count="2500"
            helper="Texto com os dizeres a serem impressos da ocorrência"
            error-label="Some error"
          >
            <q-input
              v-model="modelo.text"
...
export default {
  ...
  methods: {
    ...
    submit () {
      axios({
        baseURL: this.modelo.id ? 'https://estagio-back.herokuapp.com//ocorrencia/' + this.modelo.id : `https://estagio-back.herokuapp.com//ocorrencia`,
        timeout: 10000,
    ...
    excluiModel (id) {
      this.$q.dialog({
        ...
        axios({
          method: 'delete',
          url: 'https://estagio-back.herokuapp.com//ocorrencia/' + id,
